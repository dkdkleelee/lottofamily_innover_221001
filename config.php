...
*/
define('G5_DOMAIN', 'http://lottofamily.co.kr/');
define('G5_HTTPS_DOMAIN', 'https://lottofamily.co.kr/');
...
define('G5_MANAGER_DIR',      'manager');
define('G5_MANAGER1_DIR',      'manager1');
...
define('G5_MANAGER_URL',      G5_URL.'/'.G5_MANAGER_DIR);
...
define('G5_MANAGER_PATH',     G5_PATH.'/'.G5_MANAGER_DIR);
define('G5_MANAGER1_PATH',     G5_PATH.'/'.G5_MANAGER1_DIR);
