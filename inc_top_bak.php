...
<div id="header"> 
	...
	<div style="position:relative;width:1200px;margin:0 auto;height:110px;line-height:110px">
		<div id="sns">
		<ul>
		<li>
			<div class="hlt">
		...
		<div class="logo"><a href="/"><img src="/images/main_top_logo.gif"></a></div>
		<div class="login">
		<?=outlogin("basic");?>
		</div>		
	</div>
...
<div class="gnbWrap">
	...
	<ul>
		<li class="m1">
		<a href="javascript:m1()" class="oneDep">스팟필터 분석시스템</a>
		<p class="subDep">								
		...
		<li class="m2">
		<a href="javascript:m2()" class="oneDep">패밀리셀프조합</a>
		<p class="subDep">								
		...
		<li class="m3">
		<a href="javascript:m3()" class="oneDep">당첨 결과 보기</a>
		<p class="subDep">	
		<a href="javascript:m3s1()">패밀리수다방</a>
		<? /* ?>
		<a href="javascript:m3s2()">당첨영수증</a>
		<? */ ?>
		</p>
		</li>
		
		<li class="m4">
		<a href="javascript:m4()" class="oneDep">패밀리 시스템</a>
		<p class="subDep">	
