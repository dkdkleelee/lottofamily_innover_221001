...
if ($is_guest && !chk_captcha() && $bo_table != 'counsel') {
    alert('자동등록방지 숫자가 틀렸습니다.');
}

if ($w == '' || $w == 'r') {
    if ($member['mb_level'] < 3 && isset($_SESSION['ss_datetime'])) {
...
if ($w == '' || $w == 'r') {
	...
	if($bo_table == 'counsel') {
		$_POST['wr_name'] = ($_POST['wr_name']) ? $_POST['wr_name'] : $_POST['phone1'].$_POST['phone2'].$_POST['phone3'];
		$wr_4 = $_POST['phone1']."-".$_POST['phone2']."-".$_POST['phone3'];
	}
	...
	if(isset($_POST['wr_new_name']) && trim($_POST['wr_new_name'])) {
		$wr_name = ($_POST['wr_new_name']) ? $_POST['wr_new_name'] : $_POST['wr_name'];
	}
