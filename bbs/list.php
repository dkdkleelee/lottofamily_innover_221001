...
//b sql
if($bo_table == 'photo' && !is_admin($_SESSION['ss_mb_id'])) {
	$b_sql = "if(wr_1 = '' OR mb_id = '".$_SESSION['ss_mb_id']."',1,0) = 1";
}
...
if ($sca || $stx) {
    ...
    $sql = " select * from {$write_table} where ".($b_sql ? $b_sql." AND " : '')." wr_is_comment = 0 ";
