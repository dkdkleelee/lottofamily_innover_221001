...
$mb_extract_weekday = isset($_POST['mb_extract_weekday'])            ? trim($_POST['mb_extract_weekday'])          : "";
$mb_average_game_number == isset($_POST['mb_average_game_number'])            ? trim($_POST['mb_average_game_number'])          : "";
...
if ($w == '' || $w == 'u') {
    ...
    if ($w=='') {
        ...
        // 닉네임수정일이 지나지 않았다면
        if ($member['mb_nick_date'] > date("Y-m-d", G5_SERVER_TIME - ($config['cf_nick_modify'] * 86400)) && check_string($member['mb_nick'], G5_HANGUL + G5_ALPHABETIC + G5_NUMERIC))
...
if ($w == '') {
    $sql = " insert into {$g5['member_table']}
		     ...
		     mb_channel = '인증가입',
					 ...
					 mb_average_game_number = '".$mb_average_game_number."',
                     mb_1 = '{$mb_1}',
                     mb_2 = '{$mb_2}',
                     mb_3 = '{$mb_3}',
                     mb_4 = '{$mb_4}',
