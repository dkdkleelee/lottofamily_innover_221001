...
<section id="ol_after" class="ol">
    ...
    <ul id="ol_after_private">
        <li>
            <a href="<?php echo G5_BBS_URL ?>/memo.php" target="_blank" id="ol_after_memo" class="win_memo">
                <span class="sound_only">안 읽은 </span>쪽지<strong><?php echo $memo_not_read ?></strong>
            </a>
        </li>
        <!-- <li>
		...
		<li>
            <a href="/ace_solution/public/mypage/" target="_self" id="ol_after_pt" class="">
                마이페이지
            </a>
        </li>
        <li>
    ...
    <footer id="ol_after_ft">
		...
		<a href="/ace_solution/public/management/lotto_member.php" id="ol_after_logout" class="blue"><i class="fa fa-gear"></i> 관리</a>
		<? } ?>
