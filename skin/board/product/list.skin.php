        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width'] ?>px">
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href" style="width:<?php echo $board['bo_gallery_width'] ?>px">
					...
					<tr>
					<td colspan="2"><strong><a href="<?php echo $list[$i]['href'] ?>" class='subject'><?php echo cut_str($list[$i]['subject'], 30, "..") ?></a></strong></td>
					</tr>
					<tr>
					<td colspan="2"><span class='model'><?php if($list[$i]['wr_2']) echo "[".cut_str($list[$i]['wr_2'], 40, "..") ."]"?></span></td>
					</tr>
					</table>
                    <?php
