...
$_GET['type'] = 'user_fixed';	// 추출기 추출번호만(사용자 등록번호 제외)
...
<div class="btitle">
	...
	<div class="btitle_text"> 고정수 셀프조합기</div>
	<div class="btitle_locate">&gt; 패밀리 조합기&gt; 고정수 셀프조합기</div>
...
<div class="content_wrap">
	...
	<div style="width:100%;text-align:center;background:#e8e8e8;padding-top:50px">
		<div style="border-radius:20px;width:700px;background-color:#ffffff;margin:0px auto">
			...
			<tr>
				...
				<td>
					<!-- <div class="help_text"><i class="fa fa-question-circle fa-lg f_blue"></i> 고정수를 선택해 주세요.</div> -->
					<?php for($i=1; $i<46; $i++) { ?>
	...
	<br /><br />
	<p>생성된 조합은 마이페이지에서 다시 확인 가능합니다.</p>
	<div style="width:100%;text-align:center;background:#e8e8e8;padding-top:10px;padding-bottom:10px">
		<div id="result_container" style="border-radius:20px;background:#ffffff;height:150px;width:700px;margin:0px auto">
			...
			<div id="result_numbers" style="text-align:center;padding-top: 35px;" class="">
...
function extNumbers() {
	...
	$.ajax({
		...
		async: true,
		cache:false,
		data: {numbers: numbers, proc: 'extractInNumbers'} , // serializes the form's elements.
