...
********************************************************************************/
	...
	****************************************************************************/
	...
	$agspay->SetValue("AgsPayHome","/ace_solution/modules/inauction/pg/allthegate");			//올더게이트 결제설치 디렉토리 (상점에 맞게 수정)
...
switch($agspay->GetResult("AuthTy")) {
	...
	case 'iche': $paymethod = 'iche'; break;
	case 'onlyhp': $paymethod = 'hp'; break;
	case 'virtual': $paymethod = 'virtual'; break;
}
...
<form name=frmAGS_pay_ing method=post action="../../ia_service_buy_process.php">
<input type="hidden" name="proc" value="servicePay">
<input type="hidden" name="sb_no" value="<?=$_POST['sb_no']?>">
<input type="hidden" name="pay_method" value="<?=$paymethod?>">
<input type="hidden" name="pay_result" value="<?=$agspay->GetResult("rSuccYn")?>">
