...
<?
    ...
    include dirname(__FILE__)."/../cfg/site_conf_inc.php";
...
<form name="order_info" method="post" action="./pg/pay_pc/pp_cli_hub.php" >
...
?>
					...
					<!-- <input type="text" name="ordr_idxx" class="w200" value="" maxlength="40"/> -->
						
                    <!-- 상품명(good_name) -->
                    
                        <input type="hidden" name="good_name" class="w100" value="운동화"/>
							<!-- <input type="text" name="good_name" class="w100" value="운동화"/> -->
                    <!-- 결제금액(good_mny) - ※ 필수 : 값 설정시 ,(콤마)를 제외한 숫자만 입력하여 주십시오. -->
                   <input type="hidden" name="good_mny" class="w100" value="1004" maxlength="9"/>
							<!-- <input type="text" name="good_mny" class="w100" value="1004" maxlength="9"/>원(숫자만 입력) -->
                    <!-- 주문자명(buyr_name) -->
                    <input type="hidden" name="buyr_name" class="w100" value="홍길동"/>
							<!-- <input type="text" name="buyr_name" class="w100" value="홍길동"/> -->
                    <!-- 주문자 E-mail(buyr_mail) -->
                    <input type="hidden" name="buyr_mail" class="w200" value="test@test.co.kr" maxlength="30" /><!-- <input type="text" name="buyr_mail" class="w200" value="test@test.co.kr" maxlength="30" /> -->
                    <!-- 주문자 연락처1(buyr_tel1) -->
                    <input type="hidden" name="buyr_tel1" class="w100" value="02-2108-1000"/><!-- <input type="text" name="buyr_tel1" class="w100" value="02-2108-1000"/> -->
                    <!-- 휴대폰번호(buyr_tel2) -->
                    <input type="hidden" name="buyr_tel2" class="w100" value="010-0000-0000"/><!-- <input type="text" name="buyr_tel2" class="w100" value="010-0000-0000"/> -->
...
?>
                <!-- 주문정보 타이틀 -->
                    ...
                    <input type="hidden" name="rcvr_mail" class="w200" value="" size="30" maxlength="30" />
                    
                    <!-- 수취인 우편번호(rcvr_zipx) -->
                    <input type="hidden" name="rcvr_zipx" class="w100" value=""/>
                    
                    <!-- 수취인 주소(rcvr_add1) -->
                    <input type="hidden" name="rcvr_add1" class="" value=""/>
                    <input type="hidden" name="rcvr_add2" class="w200" value=""/>
