...
<div class="btitle">
	...
	<div class="btitle_text"> 발급번호관리</div>
	<div class="btitle_locate">&gt; 마이페이지&gt; 발급번호관리</div>
...
?>
	<div>
		 <h5 class="title"><i class="fa fa-asterisk fa-lg"></i> <?=$_GET['s_inning']?>회차  수동번호저장</h5>
	</div>
	...
	<div class="flex-wrap">
		<div class="item" style="width:250px !important;">
			...
			<div class="btn_box ac">
				<button type="button" class="as-btn small green" onClick="addNumbers();"><!-- <i class="fa fa-save"></i> --> 번호저장</button>
			</div>
			<? } else { ?>
			<div style="color:#ff3333">사용자번호등록은 월요일부터 가능합니다.</div>
			<? } ?>
			</form>
		</div>
	
		<div class="item" style="width:850px !important;float:right">
