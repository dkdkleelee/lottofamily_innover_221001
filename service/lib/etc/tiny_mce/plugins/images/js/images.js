...
$(function(){
	...
	//Session ID ¬Õ¬Ý¬ñ Flash-¬Ù¬Ñ¬Ô¬â¬å¬Ù¬é¬Ú¬Ü¬Ñ
	var SID;
	$.ajax({
		type: "POST",
		url: "connector/php/",
	...
	//¬¶¬Ý¬Ñ¬Ô ¬Ù¬Ñ¬Ô¬â¬å¬Ù¬Ü¬Ú
	var folderLoadFlag = false;
	//¬°¬ä¬Ü¬â¬í¬ä¬î ¬å¬Ü¬Ñ¬Ù¬Ñ¬ß¬ß¬å¬ð ¬á¬Ñ¬á¬Ü¬å
	...
	$('.folderClosed,.folderOpened,.folderS,.folderImages,.folderFiles').live('click',function(){
		...
		//¬©¬Ñ¬á¬â¬Ö¬ä ¬ß¬Ñ ¬á¬Ö¬â¬Ö¬Ü¬Ý¬ð¬é¬Ö¬ß¬Ú¬Ö
	...
	//¬¥¬¦¬«¬³¬´¬£¬ª¬Á ¬®¬¦¬¯¬À
	//¬°¬ä¬Ü¬â¬í¬ä¬î ¬Ù¬Ñ¬Ô¬â¬å¬Ù¬é¬Ú¬Ü ¬æ¬Ñ¬Û¬Ý¬à¬Ó
		...
		$('#newFolderBlock').slideDown('fast', function(){
			$('#newFolderBlock input').focus().blur(cancelNewFolder).keypress(function(e){
				if(e.which == 13) {
					...
					//¬©¬ß¬Ñ¬é¬Ú¬ä ¬Ó¬ã¬Ö ¬Ó¬Ö¬â¬ß¬à: a-Z0-9-_ ¬Ú ¬å¬á¬â¬Ñ¬Ó¬Ý¬Ö¬ß¬Ú¬Ö ¬Ó¬Ó¬à¬Õ¬à¬Þ
				} else {
					return false;
				}
	...
	//¬°¬ä¬Þ¬Ö¬ß¬Ú¬ä¬î ¬ã¬à¬Ù¬Õ¬Ñ¬ß¬Ú¬Ö ¬á¬Ñ¬á¬Ü¬Ú
	...
	//¬±¬à¬Õ¬ä¬Ó¬Ö¬â¬Õ¬Ú¬ä¬î ¬ã¬à¬Ù¬Õ¬Ñ¬ß¬Ú¬Ö ¬á¬Ñ¬á¬Ü¬Ú
	function saveNewFolder(){
		...
		$('#menuCancelFolder,#menuSaveFolder').hide();
		$('#menuCreateFolder').show();
		//¬©¬Ñ¬á¬â¬à¬ã ¬ß¬Ñ ¬ã¬à¬Ù¬Õ¬Ñ¬ß¬Ú¬Ö ¬á¬Ñ¬á¬Ü¬Ú + ¬ã¬Ö¬â¬Ó¬Ö¬â ¬Õ¬à¬Ý¬Ø¬Ö¬ß ¬à¬ä¬Õ¬Ñ¬ä¬î ¬ß¬à¬Ó¬å¬ð ¬ã¬ä¬â¬å¬Ü¬ä¬å¬â¬å ¬Ü¬Ñ¬ä¬Ñ¬Ý¬à¬Ô¬à¬Ó
		...
		$.ajax({
			...
			success: function(data){
				...
				if(blocks.error != '') {
					...
					//¬°¬ä¬Ü¬â¬í¬Ó¬Ñ¬Ö¬Þ ¬ã¬à¬Ù¬Õ¬Ñ¬ß¬ß¬å¬ð ¬á¬Ñ¬á¬Ü¬å
					$.ajax({
						type: "POST",
						url: "connector/php/",
	...
	$('#menuDelFiles').click(function() {
		...
		if(files.length == 0) {
			...
			if(confirm('Files to delete: '+files.length+'\n\nContinue?')) {
				...
				//¬³¬à¬Ò¬Ú¬â¬Ñ¬Ö¬Þ ¬ã¬ä¬â¬à¬Ü¬å ¬Ù¬Ñ¬á¬â¬à¬ã¬Ñ
	...
	//¬¯¬ª¬¨¬¯¬Á¬Á ¬±¬¡¬¯¬¦¬­¬¾
	//¬±¬à¬Ü¬Ñ¬Ù¬Ñ¬ä¬î ¬ä¬Ö¬Ü¬å¬ë¬å¬ð ¬Ú¬ß¬æ¬à¬â¬Þ¬Ñ¬è¬Ú¬ð
	...
	//¬°¬é¬Ú¬ã¬ä¬Ú¬ä¬î ¬á¬à¬Ý¬ñ ¬Ú¬ß¬æ¬à¬â¬Þ¬Ñ¬è¬Ú¬Ú
	...
	//¬±¬à¬Ý¬å¬é¬Ú¬ä¬î ¬ä¬Ö¬Ü¬å¬ë¬å¬ð ¬Õ¬Ú¬â¬Ö¬Ü¬ä¬à¬â¬Ú¬ð ¬Ú ¬Ö¬Ö ¬ä¬Ú¬á
	...
	//¬¯¬à¬â¬Þ¬Ñ¬Ý¬î¬ß¬Ñ¬ñ ¬Ù¬Ñ¬Ô¬â¬å¬Ù¬Ü¬Ñ
	$('#fileOpen').MultiFile({ 
		STRING: { 
