...
//echo 's['.$sg_no.']'.$num.'<br />';
	...
	*/
	...
	public function checkSMSOff() {
		...
		$query = "UPDATE ".$this->tb['Member']." a JOIN (SELECT * FROM ".$this->tb['TermServiceUse']." WHERE ABS(TIMESTAMPDIFF(DAY, NOW(), su_enddate)) < 1) b ON (a.mb_id = b.mb_id) SET a.mb_sms = 0";
