...
<div style="position:relative;height:461px;min-width:1200px;width:100%;overflow:hidden">
	<div id="nav" style="left:50%;margin-left:-50px;"></div>
		<div class="adRepeat" style="position:absolute; left:50%;margin-left:-1000px;">
			<ul id="adRepeat" style="min-width:1000px; z-index:99">
				<li><a href="javascript:m1()"><img src="images/rnw/메인/메인_반응1.png" style="width:2000px;min-width:1200px"></a></a></li>
				<li><a href="/bbs/register.php"><img src="images/rnw/메인/메인_반응2.png" style="width:2000px;min-width:1200px"></a></li>
				<li><a href="javascript:m1()"><img src="images/rnw/메인/메인_반응3.png" style="width:2000px;min-width:1200px"></a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="main_lotto">
    ...
    <img src="/images/main_cs.gif" usemap="#cs">
    <map name="cs">
...
<img src="/images/main_middle_banner.gif?v=1" usemap="#middle">
<map name="middle">
